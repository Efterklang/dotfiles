...
local TRIANGLE_LEFT = nf.ple_lower_right_triangle --[[ '' ]]
local TRIANGLE_RIGHT = nf.ple_upper_left_triangle --[[ '' ]]
...
M.setup = function()
   wezterm.on('format-tab-title', function(tab, _tabs, _panes, _config, hover, max_width)
      ...
      for _, pane in ipairs(tab.panes) do
        ...
        -- tabs
      _push('rgba(0, 0, 0, 0.4)', bg, { Intensity = 'Bold' }, TRIANGLE_LEFT)
      ...
      -- Right semi-circle
      _push('rgba(0, 0, 0, 0.4)', bg, { Intensity = 'Bold' }, TRIANGLE_RIGHT)
