...
export extern "code-insiders" [
    command?: string                # file or string to  to open. Type `code-insiders -` to read from stdin
    ...
    --goto(-g)                      # <file:line[:character]>          Open a file at the path on the specode-insidersfied line and character position
    ...
    --user-data-dir                 # Specode-insidersfies the directory that user data is kept in. Can be used to open multiple distinct instances of code-insiders
    --profile                       # <profileName> Opens the provided folder or workspace with the given profile and assocode-insidersates the profile with the workspace. If the profile does not exist, a new empty one is created. A folder or workspace must be provided for the profile to take effect
    --help(-h)                      # Print usage
    ...
    --log: string@"nu-complete log level" # Log level to use. Default is 'info'. You can also configure the log level of an extension by passing extension id and log level. For example: 'vscode-insiders.csharp:trace'
    ...
    --telemetry                     # Shows all telemetry events which VS code-insiders collects
]
...
def "nu-complete code-insiders extensions" [] {
    ^code-insiders --list-extensions | lines
}

export extern "code-insiders --list-extensions" [
    --category             # Filters installed extensions by provided category
    --show-versions        # Show versions of installed extensions
]

export extern "code-insiders --disable-extension" [
    extension: string@"nu-complete code-insiders extensions"
]

export extern "code-insiders --uninstall-extension" [
    extension: string@"nu-complete code-insiders extensions"
]

export extern "code-insiders --install-extension" [
    --pre-release          # Installs the pre-release version of the extension
    --force                # update to latest version
]

export extern "code-insiders tunnel" [
    # TODO
]

export extern "code-insiders serve-web" [
    # TODO
]
