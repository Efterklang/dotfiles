...
def sync-dotfiles [] {
    cp -r -f ~/.config/yazi/* 'e:/OneDrive - 商业版/Attachments/dotfiles/Terminal/CLI&TUI/yazi/'
    cp -r -f ~/AppData/Roaming/nushell/ 'e:/OneDrive - 商业版/Attachments/dotfiles/Terminal/Shells/nushell/'
    cp -r -f ~/Documents/PowerShell/* 'e:/OneDrive - 商业版/Attachments/dotfiles/Terminal/Shells/Powershell/'
    cp -r -f ~/.config/wezterm/* 'e:/OneDrive - 商业版/Attachments/dotfiles/Terminal/Terminal Emulator/wezterm/'
    cp -r -f ~/.glaze-wm/* 'e:/OneDrive - 商业版/Attachments/dotfiles/Application/.glaze-wm/'
    scoop export > 'e:/OneDrive - 商业版/Attachments/dotfiles/MISC/scoop_app.json'
}
...
alias typora = D:\Application\Typora\typora .
